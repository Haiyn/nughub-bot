...
export default [ping(), sessionStart(), sessionFinish(), sessionNext(), configuration(), strings()];
export { sessionStart, sessionNext, sessionFinish, ping, configuration, strings };
